...
$sql_procede = "SELECT * FROM `profissionais`";
...
<body>
    <header>
        <div class="card">
          ...
          <a class="nav-link active" aria-disabled="true" href="../backadmin/sair.php">Sair</a>
            ...
            <div class="card-body">
                <a class="nav-link active" aria-current="page" href="../cadastraprofissa.php">Cadastrar Profissional</a>
            </div>
        </div>
    </header>
    <main class="container">
        ...
        <div class="row mt-4 rounded m-2 p-2 d-flex border">
            ...
            <div class="col">Nome profissional</div>
            <div class="col"></div>
            <div class="col"></div>
        </div>
        <?php if (!empty($dados_profissa)): ?>
            <?php foreach($dados_profissa as $retorno): ?>
                <div class="row mt-4 rounded m-2 p-2 d-flex border">
                    ...
                    <div class="col">
                        <a href="../backadmin/edit/edit_profissa.php?id=<?php echo $retorno['id']; ?>" class="btn btn-success">Update</a>
                    </div>

                    <div class="col">
                        <form action="../backadmin/delete_profissa.php" method="post" onsubmit="return confirm('Tem certeza que deseja excluir este profissional?');">
                            <input type="hidden" name="id_profissional" value="<?php echo $retorno['id']; ?>">
